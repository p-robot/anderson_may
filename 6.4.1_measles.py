...
if __name__=="__main__":
    ...
    fig, ax = plt.subplots()
    ax.plot(measles.date, measles.cases, c = [0, 0, 0, 1], lw = 0.5)
    ...
    ax.set_ylabel("Weekly cases of measles (thousands)", fontsize = 10)
    ...
    plt.savefig(join('.', 'graphics', 'fig_6.3.pdf'))
    plt.close()
    ...
    ax.set_xlabel("Time lag (weeks)", fontsize = 14)
    ...
    plt.savefig(join('.', 'graphics', 'fig_6.4.pdf'))
    plt.close()
